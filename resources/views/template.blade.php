    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="/dashboard">Matematika Detik</a>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="/dashboard" aria-expanded="false" data-target="#submenu-1"
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="/levels">Level </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="/instructors">Instructor</a>
                                        </li>
                                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/result" aria-expanded="false" data-target="#submenu-5"
                                    aria-controls="submenu-5"><i class="fas fa-fw fa-table"></i>Results & Analytics</a>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            Copyright © 2024. All rights reserved. Dashboard by <a
                                href="https://instagram.com/toti.k.w">tod</a>.
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
